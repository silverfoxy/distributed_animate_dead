...
class AnimateDeadWorker implements IAnimateDeadWorker {
    ...
    public function add_termination_task($coverage_info, $execution_id, $parent_id) {
        $task_id = uniqid();
        $params = ['coverage_info' => $coverage_info, 'execution_id' => $execution_id, 'parent_id' => $parent_id];
    ...
    public function add_reanimation_task($init_env, $httpverb, $targetfile, $reanimationarray, $branch_filename, $branch_linenumber, $line_coverage_hash, $symbol_table_hash, $coverage_info, $execution_id, $parent_id, $extended_logs_emulation_mode, $new_branch_coverage=[], $current_priority=null) {
        $task_id = uniqid();
